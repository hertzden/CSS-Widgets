...
import { Title, TocDiv, ToggleButton, ToggleButtonClose, TocIcon, TocLink, TocToggle } from './styles'
...
export default function Toc({ headingSelector, getTitle, getDepth, ...rest }) {
  ...
  return (
    <>
      <ToggleButton><TocToggle opener open={open} onClick={() => setOpen(true)} /></ToggleButton>
