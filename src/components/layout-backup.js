...
const Layout = ({ location, title, children }) => {
  ...
  return (
    ...
    <div className="flex flex-1  flex-row flex-shrink-0 flex-grow flex-basis w-full items-stretch relative">
      <header role="banner" className={`items-end flex flex-col flex-grow flex-shrink-0  z-3 ${styles.header}`}>
      <div className={`flex flex-col flex-shrink-0 items-stretch flex-basis z-0 min-w-0 min-h-0 relative ${styles.header_block}`}>
          ...
          <div className={`grid flex-col flex-shrink-0 items-center flex-basis z-0 min-w-0 min-h-0 relative h-full overflow-y-auto ${styles.header_block}`}>
            ...
            <a target="_blank" rel="noopener noreferrer" href="https://github.com/hertzden" id="github"><svg width="32" height="32" viewBox="0 0 800 800"><path fill="#ddd" d="M400 139c144 0 260 116 260 260 0 115-75 213-178 247-9 3-17-2-17-13v-71c0-35-18-48-18-48 57-6 119-28 119-128 0-44-27-70-27-70s14-29-2-69c0 0-22-7-72 27-42-12-88-12-130 0-50-34-72-27-72-27-16 40-2 69-2 69s-27 26-27 70c0 100 62 122 119 128 0 0-14 10-17 35-15 7-53 18-76-22 0 0-13-25-39-27 0 0-26 0-2 16 0 0 17 8 29 38 0 0 16 51 88 35v44c0 11-9 16-18 13-103-34-178-132-178-247 0-144 116-260 260-260z"></path></svg>
            </a>
            </section>
            </div>
          </div>
        ...
        <rect fill="#e0deff" width="316" height="265"></rect><rect fill="#f86278" x="236" y="206" width="316" height="265"></rect>
        </svg>
      </header>
      <main role="main" className="flex flex-col flex-grow flex-shrink relative min-w-0 items-start min-h-0 m-0 p-0 items-start" id="main">
        ...
        <div className={`px-4 py-8 grid grid-cols-1 gap-10 pl-28 ${styles.card_grid}`}>
          {children}
        </div>
        </div>

        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1264 795" className={`${styles.dice_two}`}>
        <rect fill="#fa9eac" x="632" width="316" height="265"></rect>
