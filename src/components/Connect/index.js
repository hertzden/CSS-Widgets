...
function Connect(props) {
  return (
    ...
    <Box>
      ...
      <p>Want to find out how I can solve problems specific to HTML/CSS/Accessibility? Let's talk.</p>
      </div>
      <div className="social">
        <a target="_blank" className="icon" rel="noopener noreferrer" href="https://twitter.com/harshitpurwar">
          ...
          <span class="sr-only">Opens Twitter profile of Harshit Purwar</span>
        </a>
        <a target="_blank" className="icon" rel="noopener noreferrer" href="https://github.com/hertzden">
          ...
          <span class="sr-only">Opens Github profile of Harshit Purwar</span>
        </a>
      </div>
    </Box>
    </ConnectBox>
